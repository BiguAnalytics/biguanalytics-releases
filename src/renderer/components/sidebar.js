...
const ICONS = {
  ...
  clips: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m14.5 4.5-8 8"></path><path d="m6.5 4.5 8 8"></path><circle cx="5" cy="4" r="2"></circle><circle cx="5" cy="13" r="2"></circle><path d="M12 17h7"></path><path d="m16 14 3 3-3 3"></path></svg>',
...
const NAV_ITEMS = [
  ...
  { id: 'clips', label: 'Clips', icon: 'clips', enabled: true },
